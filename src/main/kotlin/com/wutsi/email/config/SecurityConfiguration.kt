    ...
    public companion object {
        public val SECURED_ENDPOINTS: RequestMatcher =
            org.springframework.security.web.util.matcher.OrRequestMatcher(
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/emails", "POST"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/sites/*/list/members", "DELETE")
            )
    }
}
